...
from functions import bestPoint, robot, informationGain, discount, obstacleGain
...
# Get information gain for each frontier point
		...
		for ip in range(0, len(centroids)):
			...
			# obsGain.append(obstacleGain(mapData, [centroids[ip][0], centroids[ip][1]], info_radius))
#-------------------------------------------------------------------------			
...
#-------------------------------------------------------------------------	
		if (len(id_record) > 0):
			...
			# goalPoint = bestPoint(mapData, centroid_record[winner_id], info_radius)
			# robots[id_record[winner_id]].sendGoal(goalPoint)
